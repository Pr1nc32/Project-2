...
if(isset($_POST['submit']))
{
	...
	if(isset($_GET['editid']))
	{
		...
		$sql="UPDATE staff SET staff_type='$_POST[staff_type]', staffname='$_POST[staffname]', loginid='$_POST[loginid]'";
		if($_POST['spassword'] != "")
		{
	...
	else
	{
		...
		$sql="INSERT INTO staff(staff_type, staffname, loginid, apassword, emailid, contactno, status) VALUES('$_POST[staff_type]','$_POST[staffname]','$_POST[loginid]','$pwd','$_POST[emailid]','$_POST[contactno]','$_POST[status]')";
		$qsql = mysqli_query($con,$sql);
		echo mysqli_error($con);
		if(mysqli_affected_rows($con) == 1)
		{
...
<form action="" method="post" onsubmit="return validateform()">
	...
	<div class="row" >
		...
		<div class="col-md-6">
			...
			<input name="contactno" id="contactno" placeholder="Mobile No."  class="form-control" value="<?php echo $rsedit['contactno']; ?>" >
			</div>
		</div>
...
function validateform()
{
	...
	{
		$('#id_contactno').html("Entered Mobile Number should contain 9 digits...");
		validate = "false";
	}
	//###############################################
