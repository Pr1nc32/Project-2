...
<form action="" method="post" onsubmit="return validateform()" >
	...
	<input name="mob_no" id="mob_no" placeholder="Mobile No."  class="form-control">
	</div>
	...
	<div class="register-check-box">
		<div class="check">
			<label class="checkbox"><input type="checkbox" name="checkbox" name="condition" id="condition" required><i> </i>I accept the terms and conditions</label> 
	</div>
